...
<p align="center">
  ...
  ·
  <a href="https://github.com/laleoarrow/battery-monitor/releases/tag/v3.0.10">v3.0.10 candidate notes</a>
</p>
...
> This is a frozen v3.0.10 test-package candidate; it has not been published.

- Settings now has a dedicated Menu Bar Icon page. Its choices use previews from the real Wattson and System renderers; the percentage control remains in General.
- Settings now uses a compact, fixed 720×520 window for General, Menu Bar Icon,
  and Modules without restating earlier selector changes.
- The compact grouped website install panel keeps DMG, PKG, and Homebrew
  together, while the real AppKit popover hero replaces the recreated web mock.

## Install v3.0.10

| Route | Best for | What to do |
| --- | --- | --- |
| **DMG** · Recommended | Guided installation | [Download the universal DMG](https://github.com/laleoarrow/battery-monitor/releases/download/v3.0.10/Wattson-v3.0.10-macos-universal.dmg), open it, then double-click the enclosed PKG. |
| **PKG** | Direct installation | [Download the universal PKG](https://github.com/laleoarrow/battery-monitor/releases/download/v3.0.10/Wattson-v3.0.10-macos-universal.pkg) and follow macOS Installer. |
...
> [SHA-256 manifest](https://github.com/laleoarrow/battery-monitor/releases/download/v3.0.10/SHA256SUMS.txt)
> before installation.
