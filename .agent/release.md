...
```bash
cd /Users/leoarrow/Project/mypackage/agents/电池功率
bash scripts/package_dmg.sh 2.1.3
```

The result is `dist/Wattson-v2.1.3.dmg`. Its only visible item is
...
bash scripts/verify_dmg.sh dist/Wattson-v2.1.3.dmg
...
git tag -a v2.1.3 -m "Wattson v2.1.3"
```
